...
<head>
    ...
    <meta property="og:description" content="<?= $description ?? 'TerangaHomes - Plateforme immobilière moderne' ?>">
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?= APP_URL ?>/annonces">
                            <i class="fas fa-search me-1"></i>Annonces
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= APP_URL ?>/search">
                            <i class="fas fa-filter me-1"></i>Recherche
                        </a>
                    </li>
                    <?php if ($this->isLoggedIn()): ?>
                        ...
                        <?php if ($this->isOwner()): ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?= APP_URL ?>/my-annonces">
                                <i class="fas fa-list me-1"></i>Mes annonces
                            </a>
                        </li>
                        <?php endif; ?>
                        <?php if ($this->isAdmin()): ?>
                ...
                <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown">
                                <?php if ($_SESSION['user_avatar']): ?>
                                    <img src="<?= APP_URL ?>/uploads/avatars/<?= $_SESSION['user_avatar'] ?>" class="rounded-circle me-2" width="35" height="35" alt="Avatar">
                                <?php else: ?>
                    ...
                    <?php else: ?>
                        ...
                        <li class="nav-item">
                            <a class="btn btn-primary ms-2 px-4" href="<?= APP_URL ?>/register">S'inscrire</a>
                        </li>
                    <?php endif; ?>
                </ul>
            </div>
    ...
    <?php if (isset($_SESSION['flash_success'])): ?>
        <div class="alert alert-success alert-dismissible fade show m-0 border-0" role="alert">
    ...
    <?php if (isset($_SESSION['flash_error'])): ?>
        <div class="alert alert-danger alert-dismissible fade show m-0 border-0" role="alert">
            <div class="d-flex align-items-center">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 mb-4">
                    ...
                    <p class="mb-4">Votre plateforme de confiance pour la location, la vente et la réservation d'hébergements et véhicules au Sénégal.</p>
                ...
                <div class="col-md-4 mb-4">
                    <h5 class="mb-4 fw-bold">Liens rapides</h5>
                    <ul class="list-unstyled">
                        <li class="mb-2"><a href="<?= APP_URL ?>" class="text-white text-decoration-none">
                            <i class="fas fa-chevron-right me-2 small"></i>Accueil
                        </a></li>
                        <li class="mb-2"><a href="<?= APP_URL ?>/annonces" class="text-white text-decoration-none">
                            <i class="fas fa-chevron-right me-2 small"></i>Annonces
                        </a></li>
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <div class="contact-info">
                        <p class="mb-3">
                            ...
                            <a href="mailto:contact@terangahomes.com" class="text-white text-decoration-none">
                                contact@terangahomes.com
                            </a>
                        </p>
                        <p class="mb-3">
                            <i class="fas fa-phone me-3"></i>
                            <a href="tel:+221331234567" class="text-white text-decoration-none">
                                +221 33 123 45 67
                            </a>
                        </p>
                        <p class="mb-3">
            ...
            <div class="text-center">
                <p class="mb-0">&copy; <?= date('Y') ?> TerangaHomes. Tous droits réservés.</p>
                <p class="mb-0 small mt-2">Made with <i class="fas fa-heart text-danger"></i> au Sénégal</p>
            </div>
        </div>
    </footer>
